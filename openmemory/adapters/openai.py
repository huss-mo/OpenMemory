"""
OpenAI adapter — converts OpenMemory tool schemas into the format expected by
...
>>> from openmemory.adapters.openai import get_openai_tools, handle_tool_calls
>>>
...
from openmemory.tools import ALL_TOOLS, TOOL_RUNNERS
...
def _to_openai_tool(schema: dict) -> dict:
    """Convert a single OpenMemory SCHEMA dict to an OpenAI tool definition."""
    return {
        "type": "function",
        "function": {
            "name": schema["name"],
