"""
Anthropic adapter — converts OpenMemory tool schemas into the format expected
...
>>> from openmemory.adapters.anthropic import get_anthropic_tools, handle_tool_calls
>>>
...
def _to_anthropic_tool(schema: dict) -> dict:
    """Convert a single OpenMemory SCHEMA dict to an Anthropic tool definition."""
    return {
        "name": schema["name"],
